...
func InitializeServer(conf *config.Config, currentNode routing.LocalNode) (*LivekitServer, error) {
	...
	egressProcessStore := NewEgressProcessStore()
	...
	rtcEgressLauncher := NewEgressLauncher(egressClient, rpcClient, egressStore, egressProcessStore, telemetryService)
	roomService, err := NewRoomService(roomConfig, apiConfig, router, roomAllocator, objectStore, rtcEgressLauncher)
	if err != nil {
		return nil, err
	}
	egressService := NewEgressService(egressClient, rpcClient, objectStore, egressStore, roomService, telemetryService, rtcEgressLauncher, egressProcessStore)
	...
	trafficManager := createTrafficManager(db)
